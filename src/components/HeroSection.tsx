            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="space-y-6 md:space-y-8 lg:order-1">
                <motion.img
                  ...
                  className="w-20 h-20 md:w-24 md:h-24 object-contain mb-4 md:mb-8"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.5, delay: 0.3 }}
                />

                <div className="overline text-primary-600 mb-4 md:mb-6 inline-block px-4 py-2 bg-primary-100/50 rounded-full">
                ...
                >
                  <button className="bg-primary-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg hover:bg-primary-600 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/25 transform hover:scale-105 w-full sm:w-auto text-sm md:text-base">
                    Apply for Batch 5
                  </button>
                </motion.div>
              </div>
